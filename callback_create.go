...
func init() {
	DefaultCallback.Create().Register("gorm:assign_updating_attributes", assignUpdatingAttributesCallback)
...
func createCallback(scope *Scope) {
	if !scope.HasError() {
		...
		if updateSqlSuffix != "" {
			scope.Raw(scope.SQL + updateSqlSuffix)
		}
